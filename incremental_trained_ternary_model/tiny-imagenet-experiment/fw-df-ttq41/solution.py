...
def main(config):
    ...
    if config.mode == "train":
        ...
        model_file_path = os.path.join(config.save_dir, "model_fw_df_ttq41.pth")
        ...
        train_writer = SummaryWriter(
            log_dir=os.path.join(config.log_dir, "train_fw_df_ttq41"))
        val_writer = SummaryWriter(
            log_dir=os.path.join(config.log_dir, "valid_fw_df_ttq41"))
